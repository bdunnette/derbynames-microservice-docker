...
GENERATE_NAME_DAY = env("GENERATE_NAME_DAY", default="*")
GENERATE_NAME_HOUR = env("GENERATE_NAME_HOUR", default="*")
GENERATE_NAME_MINUTE = env("GENERATE_NAME_MINUTE", default="*/5")
